...
class LabelChecker(QWidget):
    def __init__(self):
        ...
        self.max_display_sample_numbers=10000
    ...
    def update_file_list(self):
        ...
        self.files = random.sample(self.files, min(len(self.files), self.max_display_sample_numbers))
    ...
    def show_page(self):
        ...
        if len(self.files) <= self.batch_size:
            ...
            batch = random.sample(self.files, self.batch_size)
        ...
        self.progress_bar.setValue(random.randint(1, 100))
