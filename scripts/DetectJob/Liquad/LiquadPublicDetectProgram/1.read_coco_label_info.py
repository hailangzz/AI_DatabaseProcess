...
if __name__ == '__main__':
    database_source_path = r"/data/database/LiquadDatabase/yolo v5_KTH_V2.v1i.coco/"
    database_part_type = "valid"
    ...
    wire_categories_id_list = [class_id for class_id in range(0, 90)]
