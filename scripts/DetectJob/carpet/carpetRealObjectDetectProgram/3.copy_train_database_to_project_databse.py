...
if __name__ == '__main__':
    ...
    part_database_origin_path = r"/home/chenkejing/database/carpetDatabase/EMdoorRealCarpetDatabase/database_augmentor/"
    src_img_dir = part_database_origin_path + "/images"
    src_label_dir = part_database_origin_path + "/labels"

    dst_img_dir = "/home/chenkejing/database/AITotal_ProjectDatabase/carpetDatabaseProgrem/images/train"
    dst_label_dir = "/home/chenkejing/database/AITotal_ProjectDatabase/carpetDatabaseProgrem/labels/train"
