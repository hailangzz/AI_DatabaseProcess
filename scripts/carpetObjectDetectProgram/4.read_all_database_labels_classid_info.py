...
if __name__ == "__main__":
    # dataset_name = "carpet.v1i.coco"  # 数据集名称
    label_dir = "/home/chenkejing/database/carpetDatabase/rea-mini-project.v1i.coco/train/labels"# YOLO txt 文件夹
    dataset_name = label_dir.split("/")[-3]
