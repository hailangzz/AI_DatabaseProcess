        ...
        for ann in anns:
            ...
            if isinstance(ann.get('segmentation'), list):
                for seg in ann['segmentation']:
                    if len(seg) >= 6 and len(seg) % 2 == 0:   # 过滤掉了部分过小的标注点信息
                        # print(seg)
...
if __name__ == "__main__":
    origin_database = "/home/chenkejing/database/WireDatabase/TotalPublicWireDatabase/wire_public_database_batch2"
    ...
    convert_coco_to_yolov8(
        ...
        # images_dir=os.path.join(origin_database, "imgs"),
