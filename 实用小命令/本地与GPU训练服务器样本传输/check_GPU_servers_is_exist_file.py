...
if __name__ == "__main__":
    ...
    remote_dir = "/home/robot-server/data/AITotal_SegmentDatabase/plasticbagDatabaseSegment/images/train"
    # # 要搜索的文件名
    ...
    # 要搜索的文件名
    target_filename = "augment_segment_real_plasticbag_seg_0630_batch1_000008.jpg"
