...
def extract_mask_contours(coco_json_path, output_dir):
    ...
    for img_id in coco.imgs:
        ...
        if contours_per_image:
            ...
            print(f"Skipped {file_name}: no annotations")

if __name__ == "__main__":
    coco_json_path = "/home/chenkejing/database/carpetDatabase/project-w3ryd/project.v3i.coco/train/_annotations.coco.json"
