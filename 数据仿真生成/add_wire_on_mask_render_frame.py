...
# ---------- 配置 ----------
COCO_JSON = (
    "/home/chenkejing/database/Floor/Train_Data.v2i.coco/train/_annotations.coco.json"
)
IMG_DIR = "/home/chenkejing/database/Floor/Train_Data.v2i.coco/train"
WIRE_FOLDER = (
    "/home/chenkejing/database/WireDatabase/Cable.v3-v3-wosplits.coco/train/imgs"
)
OUTDIR = "./output2"
...
for ann in coco["annotations"]:
    ...
    ground_polygons[img_id].append(
        ann["segmentation"][0]
    )  # 假设 polygon 用第一个 segmentation
...
def add_wire(idx, ground_plane):
    ...
    bpy.ops.curve.primitive_bezier_curve_add(
        location=(
            random.uniform(-ground_plane.scale[0], ground_plane.scale[0]),
            random.uniform(-ground_plane.scale[1], ground_plane.scale[1]),
            0.02,
        )
    )
